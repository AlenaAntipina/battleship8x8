...
public class Battleship8x8 {
    ...
    public boolean shoot(String shot) {
        ...
        int a_1_int=0;
        switch (a_1){
            case 'A': a_1_int=0; break;
            case 'B': a_1_int=1; break;
            case 'C': a_1_int=2;break;
            case 'D': a_1_int=3;break;
            case 'E': a_1_int=4;break;
            case 'F': a_1_int=5;break;
            case 'G': a_1_int=6;break;
            case 'H': a_1_int=7;
        }

        int index;
        index = (a_2_int-1)*8+a_1_int;
        System.out.println("a_1_int="+a_1_int+" a_2_int="+a_2_int+" index="+index);
...
//        System.out.println("shoot_do = " + shoot_do);
        return shoot_do;
    }
